 ...
 * {@link #newWorkout(com.hazelcast.core.HazelcastInstance, int, int)} to create the real workout (which is not serializable).
 *
...
public interface WorkoutFactory extends Serializable {
    ...
    Workout newWorkout(HazelcastInstance hz, int memberIndex, int memberCount);
}
